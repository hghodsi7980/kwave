...
for file_number = 1:1
    for counter =1:5
        clearvars('-except','counter' , 'dataset2', 'file_number');
        disp(file_number);
        disp(counter);
        load(sprintf("Matlab_codes/mesh_space_%d",counter));
        mesh_space = mesh_space(1:2:end,1:2:end,1:2:end);
        ...
        filename = sprintf('dataset_%d.mat',file_number);
