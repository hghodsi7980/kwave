...
% % % % for counter =1:20
% % % %     clearvars('-except', 'counter' , 'dataset2');
% % % %     disp(counter);
% % % %     mesh_space = zeros(200,200,250);
% % % %     num_particles = randi(200)+10;
% % % %     for i = 1:num_particles
% % % %         mesh_space = mesh_space+makeBall(200,200,250,round(normrnd(100,25)),round(normrnd(100,25)),round(normrnd(100,25)),2);
% % % %     end
...
% % % %     dataset2(counter).number_of_spheres = num_particles;
% % % %     dataset2(counter).coordinate_x = x; %#ok<*SAGROW>
% % % %     dataset2(counter).coordinate_y = y; %#ok<*SAGROW>
% % % %     dataset2(counter).coordinate_f = z; %#ok<*SAGROW>
% % % %     dataset2(counter).spec_all = fft_1;
% % % %     dataset2(counter).frequencies = frequencies(1:200);
% % % % end
% % % % filename = 'dataset1.mat';
% % % % save(filename,'dataset2','-v7.3');
% % % % 
% % % % close all
% % % % clear
% % % % addpath(genpath('C:\GitHub\kwave\'))
