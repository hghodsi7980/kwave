...
mesh_space = makeBall(150,150,150,75,75,75,50);
x_arr = linspace(round(-size(mesh_space,1)/2),round(size(mesh_space,1)/2),size(mesh_space,1));
y_arr = linspace(round(-size(mesh_space,1)/2),round(size(mesh_space,1)/2),size(mesh_space,2));
z_arr = linspace(round(-size(mesh_space,1)/2),round(size(mesh_space,1)/2),size(mesh_space,3));
x_arr = x_arr/1000;
y_arr = y_arr/1000;
z_arr = z_arr/1000;
...
clearvars('-except', 'absorbed_energy', 'mesh_space');
